...
def get_peft_model_state_dict(model, state_dict=None):
    ...
    if model.peft_config.peft_type == PeftType.LORA or model.peft_config.peft_type == PeftType.LORAX:
...
def set_peft_model_state_dict(model, peft_model_state_dict):
    ...
    if model.peft_config.peft_type not in [PeftType.LORA, PeftType.LORAX]:
